/*
Ainoras Žukauskas VU MIF PS, 4 gr, 2 pogr

Sudaryti vienpusį sąrašą. Parašyti procedūrą, kuri įterpia prieš reikšme
nurodytą elementą naują elementą. Jeigu tokio elemento nėra, turi būti išvestas
...
int main(){
	...
	/* INSERT/SET/REMOVE */
		...
		printf("Test 28: ");					/* Clear empty vector (OK) */
		if(!remove_all(vec))
			printf("%s\n", "OK");
		else
			printf("ERR\n");
	...
	printf("Test 29: ");						/* Clear all and free */
	if(!safe_free(&vec))
		printf("%s\n", "OK");
	else
		printf("ERR\n");
